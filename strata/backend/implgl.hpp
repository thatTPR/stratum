...
virtual bool shaderModule(shaderMoudle* module);
virtual bool vertModule(vertModule* module);
virtual bool fragModule(fragModule* module);
virtual bool geomModule(geomModule* module);
virtual bool tescModule(tescModule* module);
virtual bool teseModule(teseModule* module);
virtual bool compModule(compModule* module);
virtual bool taskModule(taskModule* module);
virtual bool meshModule(meshModule* module);
virtual bool rgenModule(rgenModule* module);
virtual bool rintModule(rintModule* module);
virtual bool rahitModule(rahitModule* module);
virtual bool rchitModule(rchitModule* module);
virtual bool rmissModule(rmissModule* module);
virtual bool rcallModule(rcallModule* module);
void descriptor_set();
